...
ip_address = input("Please type in ip address:")

t = paramiko.Transport(ip_address, 22)

xname = input("Please type in username:")

t.connect(username=xname, password="alta3")
